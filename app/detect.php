...
elseif(stripos($_SERVER['HTTP_USER_AGENT'],"iPod") || stripos($_SERVER['HTTP_USER_AGENT'],"iPhone") )
{
    $_REQUEST['iphone'] = 1;
}
...
elseif (WIRELESS_PROTOCOL == 'iphone' || WIRELESS_PROTOCOL == 'Android' || WIRELESS_PROTOCOL == 'IEMobile'  ) 
{
